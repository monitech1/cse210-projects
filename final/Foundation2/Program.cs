...
class Program
{
    ...
    {
        // Order 1
        Address address1 = new Address("Odumasi Odum 127", "Kwame jeff", "Lome", "Ghana");
        Customer customer1 = new Customer("Valeria Alcala Guillen", address1);
        List<Product> productsList1 = new List<Product>();

        Product p1001 = new Product("African Print", "GH210", 67.99, 1);
        Product p1002 = new Product("Table top", "MP150", 3.50, 5);
        Product p1003 = new Product("Laptop bag", "LTB05", 1.99, 10);
        ...
        Product p2001 = new Product("African print dress", "GLSET", 4.99, 3);
        Product p2002 = new Product("Index Cards", "IC100", 1.75, 2);
        Product p2003 = new Product("Laptop bag protection", "SCC1000", 12.50, 1);
        ...
        Customer customer3 = new Customer("due north G. Mostacero", address3);
        List<Product> productsList3 = new List<Product>();

        Product p3001 = new Product("laptop bag protection", "PC100", 8.99, 2);
        Product p3002 = new Product("African print dress", "GLSET", 4.99, 4);
